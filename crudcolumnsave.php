<?php
	...
	$qry = "SELECT A.id " .
			"FROM {$_SESSION['ESCCO_DB_PREFIX']}applicationtables A " .
	...
	if ($headerid == 0) {
		$result = mysql_query("INSERT INTO {$_SESSION['ESCCO_DB_PREFIX']}applicationtables " .
	...
	$qry = "SELECT A.id " .
			"FROM {$_SESSION['ESCCO_DB_PREFIX']}applicationtablecolumns A " .
	...
	if ($itemid == 0) {
		$result = mysql_query("INSERT INTO {$_SESSION['ESCCO_DB_PREFIX']}applicationtablecolumns " .
		...
		$result = mysql_query("UPDATE {$_SESSION['ESCCO_DB_PREFIX']}applicationtablecolumns " .
				"SET width = $width, " .
