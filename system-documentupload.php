<?php
	...
	$link = mysqli_connect(ESCCO_DB_HOST, ESCCO_DB_USER, ESCCO_DB_PASSWORD, ESCCO_DB_DATABASE);
...
//	       mysql_real_escape_string
			$stmt = mysqli_prepare($link, "INSERT INTO {$_SESSION['ESCCO_DB_PREFIX']}documents " .
			...
			mysqli_stmt_bind_param($stmt, "sssssss", $sessionid, $description, $filename, $mimetype, $image, $size, $_SESSION['ESCCO_SESS_MEMBER_ID']);
