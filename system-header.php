...
<head>
<title>Escco Proposal System</title>
							...
							<div id="header" class='header1'>
								<?php		
									$qry = "UPDATE {$_SESSION['ESCCO_DB_PREFIX']}members SET " .
											...
											"WHERE member_id = " . $_SESSION['ESCCO_SESS_MEMBER_ID'] . "";
...
<?php 
										if (isUserInRole("CUSTOMER")) {
											echo 
												...
												. " ("
												. $_SESSION['ESCCO_SESS_CUSTOMER_NAME']
												. ")";
											...
											<?php 
												if (isAuthenticated()) {
										    		...
										    		if (isset($_GET['callee'])) {
														cache_function("showBreadCrumb", array("pageid" => $_SESSION['ESCCO_pageid'], "callee" => $_GET['callee']));
														
										    		} else {
														cache_function("showBreadCrumb", array("pageid" => $_SESSION['ESCCO_pageid']));
										    		}
