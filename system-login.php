...
<img src="images/login-page.png" />
		...
		<?php
			if (isset($_SESSION['ESCCO_ERRMSG_ARR'])) {
				echo "<div class='loginerror'>\n";
				echo "<img src='images/alert.png' />";
				
				for ($i = 0; $i < count($_SESSION['ESCCO_ERRMSG_ARR']); $i++) {
					echo "<p>" . $_SESSION['ESCCO_ERRMSG_ARR'][$i] . "</p>";
				}
		...
		?>
			<form action="system-login-exec.php?session=<?php echo urlencode($_GET['session']); ?>" method="post" id="loginForm">
				...
				<input type="text" name="login" id="login" value="<?php if (isset($_SESSION['ESCCO_ERR_USER'])) echo $_SESSION['ESCCO_ERR_USER']; ?>"/>
				<br/>
				<br/>
