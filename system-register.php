	...
	<form id="loginForm" enctype="multipart/form-data" name="loginForm" class="entryform manualform" method="post" action="system-register-exec.php">
	  <table border="0" align="left">
	    ...
	    <tr>
	      <td>User Type</td>
	      <td>
	      	<SELECT id="accounttype" name="accounttype" onchange="usertype_onchange()">
	      		<OPTION value="E" selected>Escco User</OPTION>
	      		<OPTION value="C">Customer User</OPTION>
	      	</SELECT>
	      </td>
	    </tr>
	    <tr style="display:none" id="customerrow">
	      <td>Customer</td>
	      <td>
	      		<?php createLazyCombo("customerid", "id", "name", "{$_SESSION['ESCCO_DB_PREFIX']}customer	")?>
	      </td>
	    </tr>
	    <tr>
	      <td>Image</td>
